...
client.user.setGame(`Quick comming soon`,"http://twitch.tv//idk");
});
...
client.on('guildMemberAdd', member => {
  member.guild.fetchInvites().then(guildInvites => {
    ...
    const logChannel = member.guild.channels.find(channel => channel.name === "quick");
...
client.on('guildMemberAdd', member => {
    ...
    const channel = member.guild.channels.find('name', 'quick');
...
if(message.content.startsWith("#move")) {
 ...
 return message.channel.send("**move [mentions]**")
}
